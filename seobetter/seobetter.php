...
define( 'SEOBETTER_VERSION', '1.5.216.56' );
...
final class SEOBetter {
    ...
    public function register_rest_routes(): void {
        ...
        // v1.5.216.56 — GSC property picker endpoints
        ...
        // v1.5.216.56 — Per-post Freshness diagnostic ("Why?" drawer + metabox tab + Gutenberg sidebar).
        ...
        // v1.5.216.56 — DEBUG-only test data seeders. Gated by WP_DEBUG at the
    ...
    /**
     * v1.5.216.56 — list every GSC property the authorized account can access.
    ...
    /**
     * v1.5.216.56 — set which GSC property the plugin syncs.
    ...
    /**
     * v1.5.216.56 — DEBUG-only: insert mock GSC snapshots so Freshness/Decay/
    ...
    /**
     * v1.5.216.56 — return per-post Freshness diagnostic for the "Why?" drawer
    ...
    public function render_metabox( \WP_Post $post ): void {
        ...
        <div id="seobetter-metabox" style="margin:-6px -12px -12px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif">
            ...
            <!-- v1.5.216.56 — Freshness panel. Lazy-loads diagnostic from REST
