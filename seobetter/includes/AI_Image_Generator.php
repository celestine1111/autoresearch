...
class AI_Image_Generator {
    ...
    const STYLE_PRESETS = [
        ...
        'hero' =>
            'Cinematic premium hero banner photograph. Subject: {subject}. Dramatic side-lighting, anamorphic lens flare, {colors} teal-and-orange film color grade, atmospheric depth, film grain, 16:9 widescreen aspect ratio, premium ad-campaign aesthetic shot like a Netflix or Apple TV+ promotional still — sharp focus on subject, soft cinematic background. The image FILLS THE ENTIRE 1200×630 FRAME EDGE-TO-EDGE. ABSOLUTELY NO black borders, NO letterbox bars, NO black bands, NO matte. The article headline MUST be rendered as CENTERED LARGE TEXT OVERLAY across the middle-third of the image: "{headline}" — set in BOLD WHITE sans-serif (Inter/Helvetica/SF Pro family), large size approximately 100-130px tall on a 1200×630 canvas, positioned in the inner 1000×500 safe zone, with subtle text-shadow or semi-transparent dark scrim behind for legibility on the photo. The headline is THE MOST IMPORTANT VISIBLE TEXT — render it clearly and prominently. NO additional text, NO logos, NO watermarks, NO chalkboards, NO menu boards, NO secondary captions, NO subtitles.',
    ...
    const STYLE_PRESETS_CLEAN = [
        ...
        'hero' =>
            'Cinematic premium hero banner photograph, {subject}, dramatic side-lighting, anamorphic lens flare, {colors} teal-and-orange film color grade, atmospheric depth, film grain, 16:9 widescreen aspect ratio, premium ad-campaign aesthetic shot like a Netflix or Apple TV+ promotional still. The image FILLS THE ENTIRE 1200×630 FRAME EDGE-TO-EDGE. ABSOLUTELY NO black borders, NO letterbox bars, NO black bands, NO matte. ABSOLUTELY NO text, NO typography, NO captions, NO chalkboards, NO menu boards, NO banners, NO signs, NO labels, NO numbers, NO watermarks, NO logos.',
