...
class Async_Generator {
    ...
    private static function get_prose_template( string $content_type, int $recipe_source_count = 3 ): array {
        $templates = [
            ...
            'press_release' => ['sections' => 'Dateline and Lede, Body, Key Facts, Quotes, FAQ, About Us, Media Contact, References', 'guidance' => 'Corporate announcement aiming for media pickup. Target 400 words total, hard ceiling 500. Formal third person throughout except inside quotes. SECTION PURPOSE: the article title you are given already serves as the H1 headline (do NOT emit another "Headline" H2). "Dateline and Lede" opens with CITY, STATE — Month DD, YYYY — and then a 25-40 word lede whose FIRST 25 words must answer who/what/when/where/why. "Body" is 3-4 paragraphs of 2-3 sentences each, inverted pyramid (most important facts first, supporting context after). "Key Facts" is a 3-5 item bullet list with named stats or numbers for AI snippet extraction. "Quotes" contains 1-2 named-executive quotes total (format: "quote sentence," said [Full Name], [Title] at [Company]), each 1-2 sentences, no cliché CEO-speak. "FAQ" is 2-3 Q&A anticipating journalist questions, 30-40 words per answer, answer-first. "About Us" is 50-100 word boilerplate — what the company does, where, since when. "Media Contact" is under 30 words — name, title, email, phone. HEADLINE RULES: the title itself must be under 70 characters with an active verb (launches, introduces, reveals, reports, announces), NOT "unveils" / "unleashes" / "disrupts". BAN LIST — these words make journalists auto-reject and must not appear anywhere in the article: groundbreaking, disruptor, disruptive, revolutionary, game-changing, industry-leading, one-stop-shop, unique, innovative, breaking, urgent, exclusive, best-in-class, cutting-edge, next-generation, world-class, leverage, synergy, unleash, unveil. Use active verbs and specific numbers instead. LINK RULES: maximum 1-2 outbound links per release (Google post-2025 treats excess as spam), no exact-match keyword anchor text. INVERTED PYRAMID: the first 25 words must make the news understandable even if the reader stops there. NO clever wordplay — direct, factual, newsworthy.', 'schema' => 'NewsArticle'],
