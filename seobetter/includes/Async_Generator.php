...
class Async_Generator {
    ...
    private static function get_prose_template( string $content_type, int $recipe_source_count = 3 ): array {
        $templates = [
            ...
            'opinion' => ['sections' => 'Key Takeaways, Hook and Thesis (one H2 combining 1-3 sentence anecdote/stat/provocation hook + nut graf stating thesis explicitly + short preview of 2-3 arguments), Argument 1 (strongest point, claim → evidence → example, 150-220 words), Argument 2 (next strongest, same structure), Argument 3 (optional — include only if total article is over 1000 words), The Objection (steelman the opposing view in one paragraph, then refute with specifics — 100-180 words), What This Means (implications and stakes, 100-150 words), FAQ (3-5 Q&A addressing common objections and "what should I do next", 40-60 words per answer, answer-first format), Conclusion and Call to Action (thesis reframed by evidence + stakes + concrete CTA), References', 'guidance' => 'Argumentative op-ed with an explicit, provable thesis stated by paragraph 3 at the latest. First person is ENCOURAGED ("I argue", "I have seen", "In my view") but avoid weak hedges ("I think", "I feel", "I believe"). Lead with a specific anecdote, a surprising stat with source, or a provocative one-line claim — never "In today\'s world". Strongest argument first, weakest never. Each argument: 1 claim sentence + 2-3 evidence sentences (named source + number) + 1 example + 1 transition. Steelman the counterargument before refuting. Every factual claim needs an outbound citation — aim for 4-8 pool-matched links per 1000 words with descriptive noun-phrase anchor text (not "click here" or naked URLs). Qualified claims beat absolutism ("in most cases" beats "always"). Label the piece as opinion somewhere in the prose. Pull out 1-2 sentences from the thesis or conclusion as candidate pull quotes (bold them with **). End with a concrete call to action (share, contact, read the cited source, act) — not "let me know what you think".', 'schema' => 'OpinionNewsArticle'],
            ...
            'press_release' => ['sections' => 'Headline (H1, under 70 characters, active verb — "launches", "introduces", "reveals", "reports", "announces" — NOT "unveils"/"unleashes"/"disrupts"), Subheadline (15-25 words supporting the news angle), Dateline and Lede Paragraph (CITY, STATE — Month DD, YYYY — first 25 words MUST answer who/what/when/where/why, 25-40 words total), Body (3-4 paragraphs of 2-3 sentences each, inverted pyramid — most important facts first, supporting context after), Key Facts (3-5 bullet list with named stats or numbers for AI snippet extraction), Quotes (1-2 quotes total from named executives — format: "quote sentence," said [Full Name], [Title] at [Company] — each quote 1-2 sentences, no cliché CEO-speak), FAQ (2-3 Q&A anticipating journalist questions, 30-40 words per answer, answer-first format), About [Company] (50-100 word boilerplate — what the company does, where, since when), Media Contact (name, title, email, phone — under 30 words), References', 'guidance' => 'Corporate announcement aiming for media pickup. Target 400 words total, hard ceiling 500. Formal third person throughout except inside quotes. JOURNALIST-ATTENTION RULES (proven data: journalists spend 5-10 seconds deciding, 70% stop reading at 200 words, 68% prefer releases under 400 words): headline under 70 characters with an active verb — NEVER start with "[Company]" or "[Company] unveils". BAN LIST — these words make journalists auto-reject: groundbreaking, disruptor, disruptive, revolutionary, game-changing, industry-leading, one-stop-shop, unique, innovative, breaking, urgent, exclusive, best-in-class, cutting-edge, next-generation, world-class, leverage, synergy, unleash, unveil. Use active verbs and specific numbers instead. QUOTE RULES: 1-2 quotes maximum (not more — dilutes the news), each attributed to a named individual with their full title and company ("said Jane Doe, CTO at Acme Inc."), sentences should make a news-worthy point with data or context, not generic "we are excited" filler. LINK RULES: maximum 1-2 outbound links per release (Google post-2025 treats excess as spam), no exact-match keyword anchor text. INVERTED PYRAMID: the first 25 words must make the news understandable even if the reader stops there. NO clever wordplay in the headline — direct, factual, newsworthy.', 'schema' => 'NewsArticle'],
