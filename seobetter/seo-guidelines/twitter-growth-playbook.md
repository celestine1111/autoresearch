# SEOBetter — Twitter Growth Playbook

> AI-driven Twitter / X strategy for SEOBetter, a WordPress plugin that generates content optimized for AI search engines (ChatGPT, Perplexity, Gemini, Google AI Overviews, Claude).
>
> **Primary goal:** Grow from 0 → 5,000 followers in 12 months and convert ≥1% to Pro subscribers ($39-179/mo) — translating to 50+ paying users from organic Twitter alone.
>
> **Secondary goal:** Build founder credibility in the AI-SEO / GEO niche so the brand becomes the obvious answer when WordPress site owners ask "how do I optimize for ChatGPT?"
>
> **Last updated:** 2026-05-02

---

## 1. Why Twitter — and why now

The AI search shift (~30% of search volume now happens inside ChatGPT / Perplexity / Gemini / Google AI Overviews vs. blue links — Princeton 2024, KDD 2024) is the wedge. Twitter / X is where:

- WordPress builders, indie hackers, SEOs, and content marketers congregate
- The conversation about "is SEO dead?" is happening daily
- AppSumo deal hunters and small-agency owners discover tools
- Build-in-public works — Mike Sutton (RankMath), Joost (Yoast), Cyrus Shepard, Aleyda Solis are all there
- Founders with under 10K followers have shipped products to 100K+ buyers via consistent posting

The category is wide open: there's no single "the AI-SEO / GEO person on Twitter" yet. SEOBetter can claim that territory if we move fast.

---

## 2. Audience — who we're targeting

**Primary buyer personas** (in order of conversion priority):

| Persona | What they want | What we give them | Tier likely to buy |
|---|---|---|---|
| **Solo blogger / small site owner** | Stop losing traffic to AI Overviews | "Generate one article that AI engines cite" | Pro $39/mo |
| **Freelance SEO consultant (1-3 client sites)** | Faster delivery, modern AI signal | Pro+ workflow, Brand Voice profiles, GSC-driven freshness | Pro+ $69/mo |
| **Content agency owner (5-10 client sites)** | Scale + bulk + white-label | Agency tier — bulk CSV, citation tracking, agency seats | Agency $179/mo |
| **Indie hacker / SaaS founder** | Cheap, fast, BYOK content for marketing site | Free BYOK tier (eventual conversion to Pro) | Free → Pro |

**Secondary engagement audience** (won't buy but amplify):
- AI / LLM enthusiasts (Anthropic / OpenAI fans)
- "Build in public" community
- WordPress core / theme developers
- AI-SEO researchers (Aleyda, Cyrus, Lily Ray, Marie Haynes orbit)
...
**Bio template:**
```
WordPress plugin that writes articles AI engines actually cite.
ChatGPT · Perplexity · Gemini · Google AI Overviews.
Built for the post-blue-link search era.
↓ free with your own AI key
```

**Pinned tweet:** A single thread showing one keyword → article → real Perplexity citation screenshot. Concrete, undeniable, ~6 tweets.

**Profile image:** Wordmark logo, not the founder's face. Keep it brand-first — the AI agent will be running the account, and a personal photo creates "is this Ben?" friction. Use the founder's face only on quote-tweets / replies signed `— Ben` for transparency.

**Banner:** Animated GIF or static graphic showing a real article ranking in AI Overviews + getting a Perplexity citation. Proof = banner.

---

## 4. Content pillars (60/25/10/5 mix)

| Pillar | % of posts | Purpose | Example formats |
|---|---|---|---|
| **Pillar 1 — AI search insights** | 60% | Establish authority, get retweeted | "ChatGPT now cites Wikipedia 2× as often as the next-most-cited domain" / Princeton GEO data / Perplexity citation patterns |
| **Pillar 2 — Plugin tactics** | 25% | Direct tool value, drive trial | "How we hit GEO 90+ on a 1500-word article in 60 seconds" / before-after screenshots / specific feature demos |
| **Pillar 3 — Build in public** | 10% | Founder credibility, community | Ship logs, MRR posts (when ready), behind-the-scenes from `BUILD_LOG.md` |
| **Pillar 4 — Spicy takes** | 5% | Viral attempts, must be defensible | "Yoast hasn't shipped an AI-SEO feature in 18 months. Here's why that matters" |

**Rule: every "spicy" take must have a real data point inside the same tweet** — opinion-only flame is cheap engagement that doesn't convert. Opinion + proof = conversion engine.

---

## 5. Posting cadence — daily schedule

| Time slot (local target audience: US + UK) | Type | Example |
|---|---|---|
| 8:00 AM ET | **Hook tweet** (Pillar 1) | One-liner data point, often with a stat |
| 12:00 PM ET | **Reply farming** (3-5 high-engagement replies) | On big SEO / WP / AI accounts |
| 3:00 PM ET | **Plugin tactic** (Pillar 2) | Screenshot + how-to |
| 7:00 PM ET | **Reply farming** (5-10 replies) | Targeting US evening + UK morning |
| Sunday 10:00 AM ET | **Long-form thread** (any pillar) | Deep dive, 8-15 tweets, run via Opus 4.7 |

That's ~3 original tweets + 8-15 replies per day. At 365 days that's ~1,100 originals + ~3,500 replies = enough surface area to grow if quality is consistent.

**Consistency beats virality.** Two weeks of silence resets the algorithm.

---

## 6. Engagement strategy — reply farming

> "Reply guy" first, "post guy" second. New accounts (under 1,000 followers) get 10× more impressions per reply on a big account than per original tweet.

**Daily reply target list (rotate, don't carpet-bomb):**

### Tier A — must-reply daily (top 10 follower-rich + on-topic)
- @aleyda — Aleyda Solis (international SEO, 100K+)
- @CyrusShepard — Cyrus Shepard (technical SEO, 60K+)
- @MarieHaynes — Marie Haynes (E-E-A-T expert, 30K+)
- @LilyRayNYC — Lily Ray (SEO + algo updates, 50K+)
- @rankmath — Rank Math plugin (50K+, fellow WP plugin)
- @yoast — Yoast SEO (100K+, most-installed WP SEO plugin)
- @aioseo — All in One SEO (35K+, fellow plugin)
- @perplexity_ai — Perplexity (180K+, AI search engine)
- @AnthropicAI — Anthropic (Claude maker, 800K+)
- @sundarpichai — Google CEO (only when AI Overviews tweet drops)

### Tier B — engage when relevant (10-20 mid-tier accounts)
- @SearchEngineRoundtable, @sengineland, @SEMrush, @Ahrefs, @MozHQ
- @arnold_vermeeren, @abrahamthillai, @glenngabe, @bill_slawski (memorial / archives)
- WordPress: @photomatt, @WordPress, @WPTavern, @wptavern_brian
- Indie SaaS: @levelsio, @marc_louvion, @arvidkahl, @dvassallo, @ramy_n_alsayed

### Tier C — niche but high-converting (small + targeted)
- AppSumo deal hunters (search "AppSumo lifetime deal" daily)
- People asking "how do I rank in ChatGPT?" / "best WordPress SEO plugin 2026"
- "Does AIOSEO work with…" / "switching from Yoast to…" — direct competitor switching intent

**Reply formula (every reply is a mini-pitch without selling):**
1. **Add specific value** — answer their question or extend their point with a concrete data point
2. **Cite something real** — link to a study, a screenshot, or BUILD_LOG SHA. Never bare-homepage cite.
3. **Show, don't tell, the product exists** — only mention SEOBetter if it directly answers the question. "We solve this — here's how" beats "BTW SEOBetter does this."

**Banned reply patterns:**
- "Great post! Check out my…" (death of an account)
- Generic agreement ("So true!")
- Plug-and-run (replying with a link to your product)
- Engagement bait ("RT this if you agree")

---

## 7. Tweet formats — templates with examples

### 7.1 Hook formats (Pillar 1 — AI search insights)
...
**The before/after:**
```
Same article. Same keyword.
Without GEO optimization → 0 AI citations in 30 days.
With GEO optimization → 14 AI citations across 4 engines.
The difference: 8 inline statistics with named sources.
```

**The contrarian observation:**
```
Everyone optimizing for Google.
Meanwhile, ChatGPT, Perplexity, Gemini and Claude are quietly stealing 30% of search volume.
And your blog appears in zero of them.
```

### 7.2 Plugin tactic formats (Pillar 2)

**The screenshot demo:**
```
Generated this article in 47 seconds.
GEO score: 94/100.
Inline citations: 8 (all real URLs from a verified pool — zero hallucination).
Schema: BlogPosting + FAQPage + ItemList auto-detected.

[screenshot of the result panel]

This is what AI engines need to cite you. Most SEO plugins don't even know.
```

**The teaching moment:**
```
"Last Updated: May 2026" at the top of every post.

Boring detail. Massive impact.

It's the #1 freshness signal AI engines use as a tiebreaker between two equally-relevant articles.

Add it manually to your top 5 posts today. Then come back here and tell me what happened in 7 days.
```

**The competitor comparison (subtle, NEVER attack-mode):**
```
Yoast SEO: 100M+ installs · checks meta tags
RankMath: 5M+ installs · adds schema
SEOBetter: 0 installs (we're new) · writes the article AND builds the schema AND grounds every citation in a real URL pool

You can have all three. They don't replace each other.
```

### 7.3 Build-in-public formats (Pillar 3)

**The ship log:**
```
v1.5.216.58 ships:
✓ Why? diagnostic drawer per post — no more "priority 75, now what?"
✓ Multilingual word count (Japanese articles weren't counted right)
✓ Actionable checklists per signal
✓ FAQ block insertion guide

Free upgrade for everyone. Even people who haven't installed yet.
```

**The number reveal (only when you have one):**
```
...
Twitter + this plugin's own Perplexity citations did 100% of it.

Here's what the first 4 weeks looked like: [thread]
```

### 7.4 Long-form Sunday thread template (Pillar 1 or 4)

```
1/ The AI search shift is real but the data is messier than you think. I spent 4 weeks measuring GEO citations across 1,200 articles. Here's what actually moves the needle. 🧵

2/ [The setup — what was measured, how, sample size]

3/ [Finding #1 — surprising data point + screenshot]

4/ [Finding #2 — counterintuitive insight]

5-10/ [Specific tactics with examples]

11/ [The misconception I had — show your wrong assumption]

12/ [What this means for WordPress site owners specifically]

13/ The full data + the methodology lives at [seobetter.com/research]
   Bookmark, retweet if useful.
   Replies open — happy to argue with anything in here.
```

**Long-form thread rules:**
- 8-15 tweets max (longer drops engagement off a cliff)
- Tweet 1 = hook with a specific number or claim
- Tweet 2 = credibility ("I measured X for Y weeks")
- Every odd-numbered tweet has a screenshot or graphic
- Last tweet = soft CTA + retweet ask

---

## 8. Visual content guidelines

Every visual asset is one of three types:

**Type A — Screenshot of real data**
- Result panel showing GEO score + word count + citations
- Perplexity / ChatGPT search showing the article being cited
- Google AI Overviews showing the article in source overlay
- AIOSEO / Yoast / RankMath showing the auto-populated schema

**Type B — Comparison graphic** (use Canva or Figma)
- Before/after GEO score
- Plugin feature matrix vs Yoast / RankMath / AIOSEO
- AI engine citation counts over time

**Type C — Quote graphic for the spicy takes**
- Single sentence on plain background, bold serif, attribution
- E.g. *"AI search is just RAG with extra steps. The articles that win are the ones that load cleanly into a research pool."*

**Avoid:**
- Stock photos of laptops / coffee / "professional people pointing at laptops"
- Founder selfies (unless on personal account or for special launches)
- AI-generated decorative images that don't show data

---

## 9. Conversion funnel — Twitter to paying customer

Every tweet should fit somewhere on this funnel:

```
1. Awareness    → Pillar 1 / 4 tweets (60-70% of impressions, 1% click rate)
2. Consideration → Pillar 2 plugin demos (10-20% of impressions, 5% click rate)
3. Trial         → Bio link → seobetter.com/free → install plugin (BYOK)
4. Activation    → Generate first article via BYOK (immediate value, no spend yet)
5. Conversion    → Hit Cloud paywall on 4th-5th article OR feature paywall (Pro features)
```

**Key conversion levers:**
- **Bio link rotation** — change weekly between `seobetter.com/free`, `seobetter.com/pricing`, and the most recent thread permalink. Track which version drives most installs.
- **Pinned tweet rotation** — Sunday's long thread becomes Monday's pinned. Re-pin top performers monthly.
- **DM autoresponder** — when someone replies "interested" or DMs us, the agent sends a polite link to the free trial + one-question response (not a sales script).

**Friction reduction:**
- Free tier = BYOK = $0 owner cost = no risk for new users
- "No credit card" callouts everywhere
- Concrete numbers in every CTA: "Generate your first article in 60 seconds. Bring your OpenAI key. We never store it."

---

## 10. Account safety / sustainability

**Don't get suspended.**

- Twitter's automated-account policy: agent-driven posting is fine if it's labeled in bio as such ("AI agent powered by SEOBetter, run by @benhandle"). Quietly automating without disclosure violates the developer agreement.
- Engage authentically. Don't mass-follow or mass-DM.
- Hard ceiling: 50 replies / day, 10 follows / day, 0 mass-DMs. The agent should respect these limits.
- Don't use shortened URLs (bit.ly, t.co) outside the auto-shorten Twitter does itself — they correlate with spam classification.

**Don't burn the brand.**
- Every tweet is reviewed by a human (Ben) for the first 90 days before posting. Build a queue, approve in batches.
- After 90 days, sample 10% of posts for review. Quality drift kills accounts faster than slow growth.
- Hard rule: never reply with sales pitches in someone's emotional thread (loss / illness / personal news). The agent must detect emotional content and skip.

**Don't argue.**
- If someone trash-talks the plugin, the agent ignores. Founder (Ben) handles publicly only when the criticism is technical and addressable. Personal attacks → block + move on.
...
## 12. KPIs — what to measure weekly

| Metric | Week 1-4 | Week 12 | Week 26 | Week 52 |
|---|---|---|---|---|
| Followers | 100 | 750 | 2,000 | 5,000 |
| Avg impressions / tweet | 500 | 3,000 | 8,000 | 20,000 |
| Bio link clicks / week | 5 | 40 | 150 | 400 |
| Plugin installs from Twitter / week | 1 | 8 | 30 | 100 |
| Pro conversions / month | 0 | 1 | 4 | 15 |
| Replies received / week | 5 | 50 | 200 | 600 |

**Weekly review ritual (Ben, every Sunday, 30 min):**
1. Top 3 tweets by engagement → why did they work? Add to the prompt's few-shot examples.
2. Bottom 3 tweets → why did they flop? Update the banned-pattern list.
3. Are we converting Twitter → install at 0.5%+ rate? If not, the bio link / pinned thread needs work.
4. Any reply-thread that turned into a real conversation? Pull the founder in for a personal reply. Humans recognize humans — it converts.
...
## 14. Common mistakes to avoid (curated from indie SaaS Twitter postmortems)

| Mistake | Why it kills accounts | What to do instead |
|---|---|---|
| Posting only product features | Reads as sales-y, kills algorithmic reach | 60% insights, 25% product, 15% other |
| Generic "growth hacker" tone | The market is saturated and skeptical | Specific data > universal advice |
| Inconsistent posting | Algorithm de-ranks intermittent accounts | Daily minimum, even if short |
| Replying only to celebrities | Big accounts ignore replies; mid-tier converts | Tier A + Tier B + Tier C mix |
| Buying followers | Twitter detects → shadowbans within weeks | Slow organic growth |
| AI-detectable copy | Hurts brand credibility ("you wrote that with ChatGPT") | Run the humanizer Claude skill on every tweet |
| Linking everywhere | Twitter de-ranks links in single tweets | Bio link only; threads can self-link last tweet |
| Long threads daily | Audience burnout | One thread per week max |
| Engagement bait ("Repost if you agree") | Twitter actively penalizes this | Earn engagement with substance |
| Ignoring DMs | Conversion happens in DMs, not in public | Set up agent autoresponder + human review |

---

## 15. Quarterly checkpoints

**Q1 (months 1-3) — establish voice + first 1,000 followers**
- Goal: 1,000 followers, 100 plugin installs from Twitter, 1-3 paying conversions
- Focus: voice consistency, daily posting, reply farming Tier A + B
- Success signal: 5+ replies per original tweet, 1+ DM/week asking real questions

**Q2 (months 4-6) — convert audience to revenue**
- Goal: 2,500 followers, $500 MRR from Twitter-attributed installs
- Focus: pinned-thread iteration, conversion funnel optimization, founder face on personal account
- Success signal: 10+ paying users explicitly cite Twitter as their discovery channel

**Q3 (months 7-9) — establish as "the AI-SEO voice"**
- Goal: 5,000 followers, $1,500 MRR, regular replies from Tier A accounts
- Focus: long-form research threads, Twitter Spaces appearances, podcast guesting
- Success signal: SEMrush / Ahrefs / Moz reposting our threads, Aleyda quoting in newsletter

**Q4 (months 10-12) — productize the audience**
- Goal: 7,500-10,000 followers, $3,000+ MRR, ready to launch on AppSumo
- Focus: AppSumo prelaunch announcement, lifetime deal seeding, post-AppSumo retention
- Success signal: AppSumo launch sells out Day 1 from waitlist alone

---

## 16. Crisis playbook

**Scenario: Plugin has a public bug / outage**
- First response (within 2 hours): acknowledgement tweet, no excuses, ETA on fix
- Followup (within 24 hours): root cause + what we changed
- Wrap (within 48 hours): one-tweet retrospective with lesson learned

**Scenario: Competitor mentions us negatively**
- Default: ignore. The mentioned-by-competitor halo effect outweighs the criticism.
- Exception: if criticism is factually wrong, founder (not agent) replies once, calmly, with proof. Block thread reply expansion if it gets ugly.

**Scenario: User accuses us of plagiarizing / scraping**
- Response: link to `external-links-policy.md` (publicly published) showing we use a research pool with verified URLs and the AI is bounded to citing only those. Show a screenshot of the validator output.

**Scenario: The agent posts something embarrassing**
- Founder deletes immediately
- Acknowledge if it gets traction ("Our AI agent posted something off-brand earlier. Removed. Improving the system prompt.")
- Update the banned-pattern list and the system prompt
- Pause auto-posting for 48 hours, full human review

---

## 17. What this playbook does NOT cover

- Paid Twitter ads — not yet, organic-first
- LinkedIn (separate playbook needed; B2B audience overlaps but voice differs)
- TikTok / YouTube / Reels — different formats, separate strategy
- Newsletter cross-promotion (eventually pair with a Substack or beehiiv)
- Affiliate / partner program (Phase 2+, after first 100 paying users)

---

## 18. Cross-references

- `pro-plan-pricing.md` — tier matrix the playbook converts users into
- `pro-features-ideas.md` — feature roadmap that fuels the build-in-public pillar
- `BUILD_LOG.md` — direct source for ship-log tweets
- `external-links-policy.md` — defensible proof point for "no hallucinated citations" claim
- `SEO-GEO-AI-GUIDELINES.md` — research backing for every Pillar 1 data drop
- `feedback_seobetter_com_marketing_site.md` (memory) — voice consistency between site + Twitter
