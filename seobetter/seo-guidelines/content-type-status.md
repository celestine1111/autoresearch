...
| 9 | `recipe` | v1.5.216.62.111 | **2026-05-08** | §3.1A Override (Recipe card structure) | ✅ | ✅ | ✅ | ✅ (full Recipe + multi-recipe + HowToStep url per step) | ✅ (yellow recipe card + ingredient/step boxes) | ⚠️ (40-country cuisine + recipe domains) | Signed off across 2 GB + 2 AU keywords (eccles cakes 808, victoria sponge 816, anzac biscuits 812+814). Backlog: AI compliance (1-2 recipes when 5 requested), inline bolds from `**word**` markdown, AU metric enforcement when source uses cups. |
| 10 | `faq_page` | v1.5.216.62.114 | — (UNTESTED post-v62.114) | Default §3.1 | ✅ | ✅ | ✅ | ✅ (FAQPage primary + Speakable) | ✅ (accordion `<details>/<summary>`, green theme — v62.114a; pre-v62.114 the doc claimed ✅ but no code existed) | ❌ | v62.114a ships Layer 5 accordion. v62.114b strengthens prompt (MANDATORY MIN 10 Q&A, 50-100w each, target 12-15). v62.114c makes audit H2-floor content-type-aware (faq_page=3) + suppresses CTA paren false-positives. NOTE: schema requires Yoast deactivated until Phase 2 PT2.1 ships `wpseo_schema_graph` filter integration. |
